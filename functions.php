...
function university_files(){
   ...
   if (strstr($_SERVER['SERVER_NAME'], 'fictional-university.local')) {
    ...
    wp_enqueue_script('main-university', get_theme_file_uri('/bundled-assets/scripts.dfcc89d7d3d1f0e144f0.js'), NULL, '1.0', true);
    wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.dfcc89d7d3d1f0e144f0.css'));
   } 
